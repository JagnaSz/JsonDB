...
public class JSONParser extends java_cup.runtime.lr_parser {
	...
	public JSONParser(java_cup.runtime.Scanner s) {
		super(s);
	}
	...
	/** Production table. */
	protected static final short _production_table[][] = unpackFromStrings(new String[] { "\000\020\000\002\005\003\000\002\002\004\000\002\003"
			+ "\005\000\002\007\003\000\002\007\005\000\002\006\005"
			+ "\000\002\004\005\000\002\010\003\000\002\010\005\000"
			+ "\002\002\003\000\002\002\003\000\002\002\003\000\002"
			+ "\002\003\000\002\002\003\000\002\002\003\000\002\002" + "\003" });
	...
	/** Parse-action table. */
	protected static final short[][] _action_table = unpackFromStrings(new String[] { "\000\032\000\004\004\005\001\002\000\004\002\001\001"
	...
	protected static final short[][] _reduce_table = unpackFromStrings(new String[] { "\000\032\000\006\003\003\005\005\001\001\000\002\001"
...
class CUP$JSONParser$actions {
	...
	public final java_cup.runtime.Symbol CUP$JSONParser$do_action(
			...
			java.util.Stack CUP$JSONParser$stack, int CUP$JSONParser$top)
			throws java.lang.Exception {
		...
		case 15: // value ::= object
		{
			...
			JSONObject o = (JSONObject) ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.peek()).value;
			RESULT = new JSONValue(o);
			CUP$JSONParser$result = parser.getSymbolFactory().newSymbol(
					"value", 0,
					((java_cup.runtime.Symbol) CUP$JSONParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$JSONParser$stack.peek()),
					RESULT);
		}
		...
		case 14: // value ::= array
		{
			...
			JSONArray a = (JSONArray) ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.peek()).value;
		...
		case 13: // value ::= BOOLEAN
		{
			...
			Boolean b = (Boolean) ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.peek()).value;
		...
		case 12: // value ::= WORD
		{
			...
			String w = (String) ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.peek()).value;
		...
		case 11: // value ::= DOUBLE
		{
			...
			Double d = (Double) ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.peek()).value;
		...
		case 9: // value ::= INTEGER
		{
			...
			Integer i = (Integer) ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.peek()).value;
		...
		case 8: // elements ::= elements COMA value
		{
			...
			int eleft = ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.elementAt(CUP$JSONParser$top - 2)).left;
			int eright = ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.elementAt(CUP$JSONParser$top - 2)).right;
			List<JSONValue> e = (List<JSONValue>) ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.elementAt(CUP$JSONParser$top - 2)).value;
			...
			JSONValue v = (JSONValue) ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.peek()).value;
			RESULT = add(e, v);
			CUP$JSONParser$result = parser.getSymbolFactory().newSymbol(
					"elements",
					6,
					((java_cup.runtime.Symbol) CUP$JSONParser$stack
							.elementAt(CUP$JSONParser$top - 2)),
					((java_cup.runtime.Symbol) CUP$JSONParser$stack.peek()),
					RESULT);
		}
			return CUP$JSONParser$result;
		...
		case 6: // array ::= LEFT_SQ_BRACKET elements RIGHT_SQ_BRACKET
		{
			...
			int eleft = ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.elementAt(CUP$JSONParser$top - 1)).left;
			int eright = ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.elementAt(CUP$JSONParser$top - 1)).right;
			List<JSONValue> e = (List<JSONValue>) ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.elementAt(CUP$JSONParser$top - 1)).value;
		...
		case 5: // pair ::= WORD COLON value
		{
			...
			int wleft = ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.elementAt(CUP$JSONParser$top - 2)).left;
			int wright = ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.elementAt(CUP$JSONParser$top - 2)).right;
			String w = (String) ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.elementAt(CUP$JSONParser$top - 2)).value;
			int vleft = ((java_cup.runtime.Symbol) CUP$JSONParser$stack.peek()).left;
		...
		case 4: // members ::= members COMA pair
		{
			...
			int mleft = ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.elementAt(CUP$JSONParser$top - 2)).left;
			int mright = ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.elementAt(CUP$JSONParser$top - 2)).right;
			List<JSONPair> m = (List<JSONPair>) ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.elementAt(CUP$JSONParser$top - 2)).value;
			...
			JSONPair p = (JSONPair) ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.peek()).value;
			RESULT = add(m, p);
			CUP$JSONParser$result = parser.getSymbolFactory().newSymbol(
					"members",
		...
		{
			Object RESULT = null;
			int start_valleft = ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.elementAt(CUP$JSONParser$top - 1)).left;
			int start_valright = ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.elementAt(CUP$JSONParser$top - 1)).right;
			JSONObject start_val = (JSONObject) ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.elementAt(CUP$JSONParser$top - 1)).value;
			RESULT = start_val;
			CUP$JSONParser$result = parser.getSymbolFactory().newSymbol(
					"$START",
					0,
					((java_cup.runtime.Symbol) CUP$JSONParser$stack
							.elementAt(CUP$JSONParser$top - 1)),
					((java_cup.runtime.Symbol) CUP$JSONParser$stack.peek()),
					RESULT);
		}
			/* ACCEPT */
		...
		case 0: // top ::= object
		{
			...
			JSONObject o = (JSONObject) ((java_cup.runtime.Symbol) CUP$JSONParser$stack
					.peek()).value;
			RESULT = o;
			CUP$JSONParser$result = parser.getSymbolFactory().newSymbol("top",
					3, ((java_cup.runtime.Symbol) CUP$JSONParser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$JSONParser$stack.peek()),
					RESULT);
		}
			return CUP$JSONParser$result;
